   	...
   	<section class="content">
   		<div class="card">
   			<div class="card-header with-border">
   				<button type="button" class="btn btn-primary" onclick="OpenWindow('registForm.do','회원등록',708, 589);" >회원등록</button>
		    		...
		    		<table class="table table-bordered">
		    			<tr>
		               	...
		               	<c:forEach items="${memberList }" var="member" >
		               	  <tr  onclick="OpenWindow('detail.do?id=${member.id}','','704','512');" style="cursor:pointer;">
		               		<td>${member.id }</td>
		               		<td>${member.name }</td>
		              		<td>
