					...
					<div class="row" style="margin : auto;">
						...
						<c:choose>
							<c:when test="${book.book_status eq 0}">
								<button type="button" style="margin : auto;" class="btn btn-primary" onclick="rentBook1('${book.book_no };removeSuccessRes1('${res.book_no }','${loginUser.id }');');">대여하기</button>
								<button type="button" class="btn btn-secondary" style="margin : auto;" onclick="removeRes1('${book.book_no }','${loginUser.id }');" >에약취소</button>
							</c:when>
...
function removeSuccessRes1(book_no, id){
...
function removeRes1(book_no, id){
